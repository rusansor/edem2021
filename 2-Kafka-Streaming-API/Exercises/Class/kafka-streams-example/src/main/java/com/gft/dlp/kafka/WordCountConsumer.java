...
public class WordCountConsumer {
    ...
    static void createWordCountStream(final StreamsBuilder builder) {
        final KStream<String, String> textLines = builder.stream(Producer.INPUT_TOPIC);
        ...
        wordCounts.toStream().to(Consumer.OUTPUT_TOPIC, Produced.with(Serdes.String(), Serdes.Long()));
